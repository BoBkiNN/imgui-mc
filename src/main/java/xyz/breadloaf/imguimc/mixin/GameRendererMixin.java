...
public class GameRendererMixin {
    ...
    @WrapOperation(method = "getProjectionMatrix", at = @At(value = "INVOKE",
            target = "Lorg/joml/Matrix4f;perspective(FFFF)Lorg/joml/Matrix4f;", remap = false))
    public Matrix4f overridePerspectiveProjection(Matrix4f instance, float fovy, float aspect, float zNear, float zFar,
